...
<div class="flex lg:grid overflow-x-auto lg:overflow-x-visible pb-4 lg:pb-0 gap-3 md:gap-6 lg:grid-cols-5 custom-scrollbar snap-x no-scrollbar pointer-events-auto">
